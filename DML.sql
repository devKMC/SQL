...
INSERT INTO example_table  # 지정되지 않았기에 전체값 입력해야함
VALUES ('문자열 데이터','텍스트데이터',99,3.14,3.14,
true,'2024-02-05',now());

# 2. 특정 열에 대하여 데이터 삽입하는 방법
# INSERT INTO 테이블명 (컬럼명1, 컬럼명2, ... );
# VALUES (데이터1, 데이터2, 데이터3, ....);
INSERT INTO example_table (int_column, boolean_column) #지정된 값에 입력 가능
VALUES (50, false);
...
# UPDATE 테이블명 SET 컬럼 1 = 데이터 1, 데이터 2, 데이터 3....;
# UPDATE 테이블명 SET 컬럼 1 = 데이터 1,........... WHERE 조건;
...
DELETE FROM example_table; # 모든 데이터 정리
...
# TURNCATE TABLE : DDL 테이블의 구조만 남기고 초기화
